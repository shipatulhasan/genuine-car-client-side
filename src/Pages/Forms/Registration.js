            ...
            <div className="space-y-1 text-sm">
              ...
              <div className="relative flex items-center justify-center">
                <input
                  ...
                  className="w-full px-4 py-3 rounded-md dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 focus:dark:border-sky-400"
                />
                <div className="absolute right-0 mt-1 mr-3 cursor-pointer text-gray-500 text-sm" onClick={()=>setIsOpen(!isOpen)}>
                    {
            ...
            <div className="space-y-1 text-sm">
              ...
              <div className="relative flex items-center justify-center">
                <input
                  ...
                  className="w-full px-4 py-3 rounded-md dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 focus:dark:border-sky-400"
                />
                <div className="absolute right-0 mt-1 mr-3 cursor-pointer text-gray-500 text-sm" onClick={()=>setIsConfirm(!isConfirm)}>
                    {
